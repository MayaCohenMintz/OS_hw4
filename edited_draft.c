...
typedef struct ThreadNode {
    ...
    void* data; // data associated with this thread
} ThreadNode;
...
// Global Queue instance + ThreadQueue instance 
...
// Initialize the queue (+ initialize the ThreadQueue)
void initQueue(void) {
    queue.front = NULL;
    queue.rear = NULL;
    ...
    queue.size = 0;
    queue.visited = 0;
    // also initializing the global variable th_queue 
    th_queue.front = NULL;
    th_queue.rear = NULL;
    th_queue.waiting = 0;
}
